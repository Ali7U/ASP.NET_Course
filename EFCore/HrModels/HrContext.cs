...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=HR;User Id=SA; Password=06_Ali@g;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId).HasName("PK__countrie__7E8CD05553E4C2C4");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__departme__C223242260DBFFFC");
        ...
        {
            entity.HasKey(e => e.DependentId).HasName("PK__dependen__F25E28CE77B45412");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__employee__C52E0BA834BCF39A");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A53CF60B84");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__location__771831EAA8C121F8");
        ...
        {
            entity.HasKey(e => e.RegionId).HasName("PK__regions__01146BAEA13D54CD");
